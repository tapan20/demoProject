...
//	public static void scrollPOSWebDown(WebElement startElement, WebElement endElement) throws InterruptedException {
//		System.out.println("Into scroll");
//
//		int startX = startElement.getLocation().getX() + (startElement.getSize().getWidth() / 2);
//		int startY = startElement.getLocation().getY() + (startElement.getSize().getHeight() / 2);
...
//
//		System.out.println(startX + " ::::::: " + startY + " ::::::: " + endX + " ::::::: " + endY);
//		Actions tAction = new TouchAction((PerformsTouchActions) chromeDriver);
//		tAction.press(PointOption.point(startX, startY)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1)))
//				.moveTo(PointOption.point(endX, endY)).release().perform();
//		System.out.println("scroll done");
//
